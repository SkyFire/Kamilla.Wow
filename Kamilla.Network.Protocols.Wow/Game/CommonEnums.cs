...
namespace Kamilla.Network.Protocols.Wow.Game
{
    ...
    {
        GlobalConfigCache       = 1 << AccountDataType.GlobalConfigCache,
        CharacterConfigCache    = 1 << AccountDataType.CharacterConfigCache,
        GlobalBindingsCache     = 1 << AccountDataType.GlobalBindingsCache,
        CharacterBindingsCache  = 1 << AccountDataType.CharacterBindingsCache,
        GlobalMacrosCache       = 1 << AccountDataType.GlobalMacrosCache,
        CharacterMacrosCache    = 1 << AccountDataType.CharacterMacrosCache,
        CharacterLayoutCache    = 1 << AccountDataType.CharacterLayoutCache,
        CharacterChatCache      = 1 << AccountDataType.CharacterChatCache,

        GlobalCache = GlobalConfigCache | GlobalBindingsCache | GlobalMacrosCache,
        CharacterCache = CharacterConfigCache | CharacterBindingsCache |
            CharacterMacrosCache | CharacterLayoutCache | CharacterChatCache
    }

    public enum AccountDataType
    {
        GlobalConfigCache = 0,
        CharacterConfigCache = 1,
        GlobalBindingsCache = 2,
        CharacterBindingsCache = 3,
        GlobalMacrosCache = 4,
        CharacterMacrosCache = 5,
        CharacterLayoutCache = 6,
        CharacterChatCache = 7,
        End = 8
    }
}
