...
namespace Kamilla.Network.Protocols.Wow
{
    public enum WowOpcodes : uint
    {
        ...
        // DF
        CMSG_DF_PROPOSAL_RESPONSE = UNKNOWN_OPCODE, /* old 0x362, */ // CMSG AcceptProposal, RejectProposal
        CMSG_DF_JOIN = UNKNOWN_OPCODE, /* old 0x35C, */ // CMSG JoinLFG
        CMSG_DF_SET_ROLES = UNKNOWN_OPCODE, /* old 0x36A, */ // CMSG SetLFGRoles
        CMSG_DF_TELEPORT = UNKNOWN_OPCODE, /* old 0x370, */    // CMSG LFGTeleport
        CMSG_DF_BOOT_PLAYER_VOTE = UNKNOWN_OPCODE, /* old 0x36C, */ // CMSG SetLFGBootVote
        ...
        CMSG_DF_SET_COMMENT = UNKNOWN_OPCODE, /* old 0x366, */ // CMSG SetLFGComment
        CMSG_DF_GET_JOIN_STATUS = UNKNOWN_OPCODE, /* old 0x296, */ // EVENT_LFG_UPDATE
        CMSG_DF_LEAVE = UNKNOWN_OPCODE, /* old 0x35D, */ // CMSG LeaveLFG
        CMSG_DF_SEARCH_JOIN = UNKNOWN_OPCODE, /* old 0x35E, */ // CMSG SearchLFGJoin
        CMSG_DF_SEARCH_LEAVE = UNKNOWN_OPCODE, /* old 0x35F, */ // CMSG SearchLFGLeave
        ...
        SMSG_WAIT_QUEUE_UPDATE = UNKNOWN_OPCODE,
        [Description("Added in 4.3.2")]
        SMSG_WAIT_QUEUE_FINISH = UNKNOWN_OPCODE,
    }
/*
        [Description("")]
*/
