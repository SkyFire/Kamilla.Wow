...
namespace Kamilla.Network.Protocols.Wow.Latest.OpcodeDatas
{
    ...
    public interface IOpcodeData
    {
        ...
        /// <summary>
        /// When overriden in a derived class, creates a new instance of <see cref="Kamilla.Network.Protocols.Wow.Latest.CustomPacket"/>
        /// that represents the current packet.
        /// </summary>
        /// <returns>
        /// A new instance of <see cref="Kamilla.Network.Protocols.Wow.Latest.CustomPacket"/>,
        /// that represents the current packet.
        /// </returns>
    ...
    public abstract class OpcodeData : IOpcodeData
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="Kamilla.Network.Protocols.Wow.Latest.CustomPacket"/> using the specified opcode and direction,
